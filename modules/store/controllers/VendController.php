...
use app\modules\store\models\VendSearch;
...
/**
 * VendController implements the CRUD actions for Vend model.
 */
class VendController extends ActiveController
{
    public $modelClass = Vend::class;
