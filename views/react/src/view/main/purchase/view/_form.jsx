...
// import MenuPurchase from '@mui/material/MenuPurchase';
import Icon from "@mui/material/Icon";
import SelectInput from "components/SelectInput";
import FileInput from "components/FileInput";
import { getVendorList, getItemList, getStoreList, getPurchaseStatus, getCustomerList } from "../service";

const PurchaseForm = ({ control, handleSubmit, onSubmitHandler, isNewPurchase, errors, getValues, setValue }) => {
    ...
    const handleVendor = async (value) => {
    ...
    const handleStatus = async (value) => {
        return await getPurchaseStatus(value)
            .then((res) => {
                if (res.flag) {
                    return res.data;
                }
                    ...
                    <Box pt={2} pb={3} px={3}>
                        <form onSubmit={handleSubmit(onSubmitHandler)}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} lg={3}>
                                    <SuiTypography variant="subtitle2" component="div">Supplier</SuiTypography>
                                    <Controller
                                        name="fvend"
                                        control={control}
                                        render={({ field, fieldState }) => {
                                ...
                                <Grid item xs={3}>
                                    <SuiButton style={{ float: "right" }} type="submit" buttonColor={isNewPurchase ? "primary" : "secondary"}>
                                        {isNewPurchase ? "Save" : "Update"}
                                    </SuiButton>
                                </Grid>
                            </Grid>
                        </form>
