...
import vendIcon from "assets/images/user.png";

const VendForm = ({ control, handleSubmit, onSubmitHandler, isNewVend, errors, getValues }) => {
                            ...
                            <Grid item xs={12} lg={3}>
                                ...
                                >
                                    <Grid item xs={12} >
                                        ...
                                        >
                                            <img
                                                src={selectedImage ? URL.createObjectURL(selectedImage) : (getValues("img") ? getValues("img") : vendIcon)}
            ...
            <Grid container spacing={2} direction="row">
                ...
                <Grid item xs={12}>
                    <SuiButton variant="outlined" buttonColor="info" style={{ width: "100%" }} onClick={() => append({ type: "Mobile", phone: '' })}>
                        <Icon className="material-icons-round">add</Icon> Add Vendor
                    </SuiButton>
                </Grid>
                <Grid item xs={12}>
                    <SuiButton style={{ float: "right" }} type="submit" buttonColor={isNewVend ? "primary" : "secondary"}>
                        {isNewVend ? "Save" : "Update"}
                    </SuiButton>
                </Grid>
            </Grid>
        </form >
...
VendForm.defaultProps = {
    isNewVend: true,
};

VendForm.propTypes = {
    isNewVend: PropTypes.bool,
    control: PropTypes.object.isRequired,
    handleSubmit: PropTypes.func.isRequired,
    onSubmitHandler: PropTypes.func.isRequired,
};

export default VendForm;